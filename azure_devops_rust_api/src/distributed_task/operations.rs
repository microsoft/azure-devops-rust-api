...
impl Client {
    ...
    pub fn agentclouds(&self) -> agentclouds::Client {
        agentclouds::Client(self.clone())
    }
    pub fn agentcloudtypes(&self) -> agentcloudtypes::Client {
        agentcloudtypes::Client(self.clone())
    }
    pub fn agents(&self) -> agents::Client {
        agents::Client(self.clone())
    }
    pub fn deploymentgroups(&self) -> deploymentgroups::Client {
        deploymentgroups::Client(self.clone())
    }
    pub fn environmentdeployment_records(&self) -> environmentdeployment_records::Client {
    ...
    pub fn kubernetes(&self) -> kubernetes::Client {
    ...
    pub fn taskgroups(&self) -> taskgroups::Client {
        taskgroups::Client(self.clone())
    }
    pub fn variablegroups(&self) -> variablegroups::Client {
        variablegroups::Client(self.clone())
    }
    pub fn yamlschema(&self) -> yamlschema::Client {
...
pub enum Error {
    #[error(transparent)]
    Agentclouds_List(#[from] agentclouds::list::Error),
    #[error(transparent)]
    Agentclouds_Add(#[from] agentclouds::add::Error),
    #[error(transparent)]
    Agentclouds_Get(#[from] agentclouds::get::Error),
    #[error(transparent)]
    Agentclouds_Update(#[from] agentclouds::update::Error),
    #[error(transparent)]
    Agentclouds_Delete(#[from] agentclouds::delete::Error),
    #[error(transparent)]
    Requests_List(#[from] requests::list::Error),
    #[error(transparent)]
    Agentcloudtypes_List(#[from] agentcloudtypes::list::Error),
    #[error(transparent)]
    Pools_GetAgentPoolsByIds(#[from] pools::get_agent_pools_by_ids::Error),
    #[error(transparent)]
    Pools_Add(#[from] pools::add::Error),
    #[error(transparent)]
    ...
    #[error(transparent)]
    Agents_List(#[from] agents::list::Error),
    #[error(transparent)]
    Agents_Add(#[from] agents::add::Error),
    #[error(transparent)]
    Agents_Get(#[from] agents::get::Error),
    #[error(transparent)]
    Agents_ReplaceAgent(#[from] agents::replace_agent::Error),
    #[error(transparent)]
    Agents_Update(#[from] agents::update::Error),
    #[error(transparent)]
    Agents_Delete(#[from] agents::delete::Error),
    #[error(transparent)]
    Variablegroups_Add(#[from] variablegroups::add::Error),
    #[error(transparent)]
    Variablegroups_ShareVariableGroup(#[from] variablegroups::share_variable_group::Error),
    #[error(transparent)]
    Variablegroups_Update(#[from] variablegroups::update::Error),
    #[error(transparent)]
    Variablegroups_Delete(#[from] variablegroups::delete::Error),
    #[error(transparent)]
    Yamlschema_Get(#[from] yamlschema::get::Error),
    #[error(transparent)]
    Deploymentgroups_List(#[from] deploymentgroups::list::Error),
    #[error(transparent)]
    Deploymentgroups_Add(#[from] deploymentgroups::add::Error),
    #[error(transparent)]
    Deploymentgroups_Get(#[from] deploymentgroups::get::Error),
    #[error(transparent)]
    Deploymentgroups_Update(#[from] deploymentgroups::update::Error),
    #[error(transparent)]
    Deploymentgroups_Delete(#[from] deploymentgroups::delete::Error),
    #[error(transparent)]
    Targets_List(#[from] targets::list::Error),
    #[error(transparent)]
    Targets_Update(#[from] targets::update::Error),
    #[error(transparent)]
    ...
    #[error(transparent)]
    Environments_Add(#[from] environments::add::Error),
    #[error(transparent)]
    ...
    #[error(transparent)]
    EnvironmentdeploymentRecords_List(#[from] environmentdeployment_records::list::Error),
    #[error(transparent)]
    Kubernetes_Add(#[from] kubernetes::add::Error),
    #[error(transparent)]
    Kubernetes_Get(#[from] kubernetes::get::Error),
    #[error(transparent)]
    Kubernetes_Delete(#[from] kubernetes::delete::Error),
    #[error(transparent)]
    Queues_GetAgentQueuesForPools(#[from] queues::get_agent_queues_for_pools::Error),
    #[error(transparent)]
    Queues_Add(#[from] queues::add::Error),
    #[error(transparent)]
    Queues_Get(#[from] queues::get::Error),
    #[error(transparent)]
    Queues_Delete(#[from] queues::delete::Error),
    #[error(transparent)]
    Taskgroups_Add(#[from] taskgroups::add::Error),
    #[error(transparent)]
    Taskgroups_List(#[from] taskgroups::list::Error),
    #[error(transparent)]
    Taskgroups_Update(#[from] taskgroups::update::Error),
    #[error(transparent)]
    Taskgroups_Delete(#[from] taskgroups::delete::Error),
    #[error(transparent)]
    Variablegroups_GetVariableGroupsById(#[from] variablegroups::get_variable_groups_by_id::Error),
    #[error(transparent)]
    Variablegroups_Get(#[from] variablegroups::get::Error),
    #[error(transparent)]
    Pools_GetAgentPools(#[from] pools::get_agent_pools::Error),
    #[error(transparent)]
    Queues_GetAgentQueuesByNames(#[from] queues::get_agent_queues_by_names::Error),
    #[error(transparent)]
    Queues_GetAgentQueuesByIds(#[from] queues::get_agent_queues_by_ids::Error),
    #[error(transparent)]
    Queues_GetAgentQueues(#[from] queues::get_agent_queues::Error),
    #[error(transparent)]
    Variablegroups_GetVariableGroups(#[from] variablegroups::get_variable_groups::Error),
}
pub mod agentclouds {
    use super::{models, API_VERSION};
    ...
    pub mod list {
        ...
        impl Builder {
            pub fn into_future(
                ...
                'static,
                std::result::Result<models::TaskAgentCloudList, Error>,
            > {
                Box::pin(async move {
                    let url_str = &format!(
    ...
    pub mod add {
        ...
        impl Builder {
            pub fn into_future(
                ...
                'static,
                std::result::Result<models::TaskAgentCloud, Error>,
            > {
                Box::pin(async move {
                    let url_str = &format!(
                        "{}/{}/_apis/distributedtask/agentclouds",
    ...
    pub mod list {
        ...
        impl Builder {
            pub fn into_future(
                ...
                'static,
                std::result::Result<models::TaskAgentCloudRequestList, Error>,
            > {
                Box::pin(async move {
                    let url_str = &format!(
    ...
    pub mod list {
        ...
        impl Builder {
            pub fn into_future(
                ...
                'static,
                std::result::Result<models::TaskAgentCloudTypeList, Error>,
            > {
                Box::pin(async move {
                    let url_str = &format!(
    ...
    pub mod get_agent_pools_by_ids {
        ...
        impl Builder {
            ...
            pub fn into_future(
                ...
                'static,
                std::result::Result<models::TaskAgentPoolList, Error>,
            > {
                Box::pin(async move {
                    let url_str = &format!(
                    ...
                    url.query_pairs_mut()
                        .append_pair("api-version", super::API_VERSION);
                    let pool_ids = &self.pool_ids;
                    url.query_pairs_mut().append_pair("poolIds", pool_ids);
    ...
    pub mod add {
        ...
        impl Builder {
            pub fn into_future(
                ...
                'static,
                std::result::Result<models::TaskAgentPool, Error>,
            > {
                Box::pin(async move {
                    let url_str = &format!(
                        "{}/{}/_apis/distributedtask/pools",
            ...
            > {
                Box::pin(async move {
                    ...
                    if let Some(pool_name) = &self.pool_name {
                        url.query_pairs_mut().append_pair("poolName", pool_name);
                    }
                    if let Some(properties) = &self.properties {
                        url.query_pairs_mut().append_pair("properties", properties);
                    }
                    if let Some(pool_type) = &self.pool_type {
                        url.query_pairs_mut().append_pair("poolType", pool_type);
                    }
                    if let Some(action_filter) = &self.action_filter {
                        url.query_pairs_mut()
                            .append_pair("actionFilter", action_filter);
...
pub mod agents {
    ...
    pub mod list {
        ...
        impl Builder {
            ...
            pub fn into_future(
                ...
                'static,
                std::result::Result<models::TaskAgentList, Error>,
            > {
                Box::pin(async move {
                    let url_str = &format!(
                    ...
                    if let Some(include_capabilities) = &self.include_capabilities {
                        url.query_pairs_mut()
                            .append_pair("includeCapabilities", &include_capabilities.to_string());
                    }
                    if let Some(include_assigned_request) = &self.include_assigned_request {
                    ...
                    if let Some(include_last_completed_request) =
                        &self.include_last_completed_request
                    {
                        url.query_pairs_mut().append_pair(
                    ...
                    if let Some(demands) = &self.demands {
                        url.query_pairs_mut().append_pair("demands", demands);
                    }
                    let req_body = azure_core::EMPTY_BODY;
                    req_builder = req_builder.uri(url.as_str());
                    let req = req_builder.body(req_body).map_err(Error::BuildRequest)?;
    ...
    pub mod add {
        ...
        impl Builder {
            pub fn into_future(
                self,
            ) -> futures::future::BoxFuture<'static, std::result::Result<models::TaskAgent, Error>>
            {
                Box::pin(async move {
                    let url_str = &format!(
                        "{}/{}/_apis/distributedtask/pools/{}/agents",
                    ...
                    match rsp_status {
                        http::StatusCode::OK => {
                            let rsp_body = azure_core::collect_pinned_stream(rsp_stream)
                                .await
                                .map_err(Error::ResponseBytes)?;
                            let rsp_value: models::TaskAgent = serde_json::from_slice(&rsp_body)
...
pub mod variablegroups {
    ...
    impl Client {
        ...
        pub fn share_variable_group(
            &self,
            organization: impl Into<String>,
            body: impl Into<Vec<models::VariableGroupProjectReference>>,
    ...
    pub mod add {
        ...
        impl Builder {
            pub fn into_future(
                ...
                'static,
                std::result::Result<models::VariableGroup, Error>,
            > {
                Box::pin(async move {
                    let url_str = &format!(
        ...
        impl Builder {
            pub fn into_future(
                ...
                Box::pin(async move {
                    ...
                    req_builder = req_builder.header("content-type", "application/json");
                    let req_body = azure_core::to_json(&self.body).map_err(Error::Serialize)?;
                    let variable_group_id = &self.variable_group_id;
                    url.query_pairs_mut()
    ...
    pub mod get_variable_groups_by_id {
        ...
        impl Builder {
            pub fn into_future(
                ...
                'static,
                std::result::Result<models::VariableGroupList, Error>,
            > {
                Box::pin(async move {
                    let url_str = &format!(
                        "{}/{}/{}/_apis/distributedtask/variablegroups",
                    ...
                    url.query_pairs_mut().append_pair("groupIds", group_ids);
                    let req_body = azure_core::EMPTY_BODY;
                    req_builder = req_builder.uri(url.as_str());
                    let req = req_builder.body(req_body).map_err(Error::BuildRequest)?;
                    let rsp = self.client.send(req).await.map_err(Error::SendRequest)?;
        ...
        impl Builder {
            ...
            ) -> futures::future::BoxFuture<'static, std::result::Result<serde_json::Value, Error>>
            {
                Box::pin(async move {
                    ...
                    url.query_pairs_mut()
                        .append_pair("api-version", super::API_VERSION);
                    if let Some(validate_task_names) = &self.validate_task_names {
                        url.query_pairs_mut()
    ...
    pub mod list {
        ...
        impl Builder {
            ...
            pub fn into_future(
                ...
                'static,
                std::result::Result<models::DeploymentGroupList, Error>,
            > {
                Box::pin(async move {
                    let url_str = &format!(
    ...
    pub mod add {
        ...
        impl Builder {
            pub fn into_future(
                ...
                'static,
                std::result::Result<models::DeploymentGroup, Error>,
            > {
                Box::pin(async move {
                    let url_str = &format!(
                        "{}/{}/{}/_apis/distributedtask/deploymentgroups",
...
pub mod targets {
    ...
    impl Client {
        ...
        pub fn update(
            &self,
            organization: impl Into<String>,
            body: impl Into<Vec<models::DeploymentTargetUpdateParameter>>,
            project: impl Into<String>,
            deployment_group_id: i32,
        ) -> update::Builder {
            update::Builder {
    ...
    pub mod list {
        ...
        impl Builder {
            ...
            pub fn into_future(
                ...
                'static,
                std::result::Result<models::DeploymentMachineList, Error>,
            > {
                Box::pin(async move {
                    let url_str = &format!(
                    ...
                    if let Some(partial_name_match) = &self.partial_name_match {
                        url.query_pairs_mut()
                    ...
                    if let Some(agent_status) = &self.agent_status {
                        url.query_pairs_mut()
                            .append_pair("agentStatus", agent_status);
                    }
                    if let Some(agent_job_result) = &self.agent_job_result {
                        url.query_pairs_mut()
    ...
    pub mod get {
        ...
        impl Builder {
            ...
            pub fn into_future(
                ...
                'static,
                std::result::Result<models::DeploymentMachine, Error>,
            > {
                Box::pin(async move {
                    let url_str = &format!(
                        "{}/{}/{}/_apis/distributedtask/deploymentgroups/{}/targets/{}",
    ...
    pub mod list {
        ...
        impl Builder {
            ...
            pub fn into_future(
                ...
                'static,
                std::result::Result<models::EnvironmentInstanceList, Error>,
            > {
                Box::pin(async move {
                    let url_str = &format!(
    ...
    pub mod add {
        ...
        impl Builder {
            pub fn into_future(
                ...
                'static,
                std::result::Result<models::EnvironmentInstance, Error>,
            > {
                Box::pin(async move {
                    let url_str = &format!(
                        "{}/{}/{}/_apis/distributedtask/environments",
        ...
        impl Builder {
            ...
            > {
                Box::pin(async move {
                    ...
                    url.query_pairs_mut()
                        .append_pair("api-version", super::API_VERSION);
                    if let Some(expands) = &self.expands {
                        url.query_pairs_mut().append_pair("expands", expands);
                    }
                    let req_body = azure_core::EMPTY_BODY;
                    req_builder = req_builder.uri(url.as_str());
                    let req = req_builder.body(req_body).map_err(Error::BuildRequest)?;
    ...
    pub mod list {
        ...
        impl Builder {
            ...
            pub fn into_future(
                ...
                'static,
                std::result::Result<models::EnvironmentDeploymentExecutionRecordList, Error>,
            > {
                Box::pin(async move {
                    let url_str = & format ! ("{}/{}/{}/_apis/distributedtask/environments/{}/environmentdeploymentrecords" , self . client . endpoint () , & self . organization , & self . project , & self . environment_id) ;
                    let mut url = url::Url::parse(url_str).map_err(Error::ParseUrl)?;
                    let mut req_builder = http::request::Builder::new();
                    req_builder = req_builder.method(http::Method::GET);
                    let credential = self.client.token_credential();
    ...
    pub mod add {
        ...
        impl Builder {
            pub fn into_future(
                ...
                'static,
                std::result::Result<models::KubernetesResource, Error>,
            > {
                Box::pin(async move {
                    let url_str = &format!(
    ...
    pub mod get_agent_queues_for_pools {
        ...
        impl Builder {
            ...
            pub fn into_future(
                ...
                'static,
                std::result::Result<models::TaskAgentQueueList, Error>,
            > {
                Box::pin(async move {
                    let url_str = &format!(
    ...
    pub mod add {
        ...
        impl Builder {
            ...
            pub fn into_future(
                ...
                'static,
                std::result::Result<models::TaskAgentQueue, Error>,
            > {
                Box::pin(async move {
                    let url_str = &format!(
                        "{}/{}/{}/_apis/distributedtask/queues",
                    ...
                    req_builder = req_builder.header("content-type", "application/json");
                    let req_body = azure_core::to_json(&self.body).map_err(Error::Serialize)?;
                    if let Some(authorize_pipelines) = &self.authorize_pipelines {
                        url.query_pairs_mut()
                            .append_pair("authorizePipelines", &authorize_pipelines.to_string());
                    }
                    req_builder = req_builder.uri(url.as_str());
                    let req = req_builder.body(req_body).map_err(Error::BuildRequest)?;
                    let rsp = self.client.send(req).await.map_err(Error::SendRequest)?;
        ...
        impl Builder {
            ...
            > {
                Box::pin(async move {
                    ...
                    url.query_pairs_mut().append_pair("queueNames", queue_names);
                    if let Some(action_filter) = &self.action_filter {
                        url.query_pairs_mut()
                            .append_pair("actionFilter", action_filter);
                    }
        ...
        impl Builder {
            ...
            > {
                Box::pin(async move {
                    ...
                    url.query_pairs_mut().append_pair("queueIds", queue_ids);
                    if let Some(action_filter) = &self.action_filter {
                        url.query_pairs_mut()
                            .append_pair("actionFilter", action_filter);
                    }
            ...
            > {
                Box::pin(async move {
                    ...
                    if let Some(queue_name) = &self.queue_name {
                        url.query_pairs_mut().append_pair("queueName", queue_name);
                    }
                    if let Some(action_filter) = &self.action_filter {
                        url.query_pairs_mut()
                            .append_pair("actionFilter", action_filter);
...
pub mod taskgroups {
    ...
    pub mod add {
        ...
        impl Builder {
            pub fn into_future(
                self,
            ) -> futures::future::BoxFuture<'static, std::result::Result<models::TaskGroup, Error>>
            {
                Box::pin(async move {
                    let url_str = &format!(
                    ...
                    match rsp_status {
                        http::StatusCode::OK => {
                            let rsp_body = azure_core::collect_pinned_stream(rsp_stream)
                                .await
                                .map_err(Error::ResponseBytes)?;
                            let rsp_value: models::TaskGroup = serde_json::from_slice(&rsp_body)
                                .map_err(|source| Error::Deserialize(source, rsp_body.clone()))?;
                            Ok(rsp_value)
                        }
                        status_code => {
    ...
    pub mod list {
        ...
        impl Builder {
            ...
            pub fn into_future(
                ...
                'static,
                std::result::Result<models::TaskGroupList, Error>,
            > {
                Box::pin(async move {
                    let url_str = &format!(
                        "{}/{}/{}/_apis/distributedtask/taskgroups/{}",
