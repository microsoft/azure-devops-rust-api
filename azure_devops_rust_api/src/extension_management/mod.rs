...
pub mod installed_extensions {
    ...
    pub mod list {
        ...
        pub struct Response(
            azure_core::http::Response<
                models::InstalledExtensionList,
                azure_core::http::JsonFormat,
            >,
        );
        impl Response {
            pub fn into_body(self) -> azure_core::Result<models::InstalledExtensionList> {
                self.0.into_model()
            }
    ...
    pub mod update {
        ...
        #[derive(Debug)]
        pub struct Response(
            azure_core::http::Response<models::InstalledExtension, azure_core::http::JsonFormat>,
        );
        impl Response {
            pub fn into_body(self) -> azure_core::Result<models::InstalledExtension> {
                self.0.into_model()
            }
            pub fn into_raw_response(self) -> azure_core::http::RawResponse {
                self.0.into()
