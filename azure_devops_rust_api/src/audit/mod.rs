...
pub mod actions {
    ...
    pub mod list {
        ...
        impl Response {
            pub fn into_body(self) -> azure_core::Result<models::AuditActionInfoList> {
                self.0.into_model()
            }
...
pub mod audit_log {
    ...
    pub mod query {
        ...
        impl Response {
            pub fn into_body(self) -> azure_core::Result<models::AuditLogQueryResult> {
                self.0.into_model()
            }
            pub fn into_raw_response(self) -> azure_core::http::RawResponse {
                self.0.into()
...
pub mod streams {
    ...
    pub mod query_all_streams {
        ...
        impl Response {
            pub fn into_body(self) -> azure_core::Result<models::AuditStreamList> {
                self.0.into_model()
            }
            pub fn into_raw_response(self) -> azure_core::http::RawResponse {
                self.0.into()
    ...
    pub mod create {
        ...
        impl Response {
            pub fn into_body(self) -> azure_core::Result<models::AuditStream> {
                self.0.into_model()
            }
            pub fn into_raw_response(self) -> azure_core::http::RawResponse {
                self.0.into()
