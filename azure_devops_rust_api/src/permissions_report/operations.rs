...
pub enum Error {
    #[error(transparent)]
    PermissionsReport_List(#[from] permissions_report::list::Error),
    #[error(transparent)]
    PermissionsReport_Create(#[from] permissions_report::create::Error),
    #[error(transparent)]
    PermissionsReport_Get(#[from] permissions_report::get::Error),
    #[error(transparent)]
    PermissionsReportDownload_Download(#[from] permissions_report_download::download::Error),
}
    ...
    pub mod list {
        ...
        impl Builder {
            pub fn into_future(
                ...
                'static,
                std::result::Result<models::PermissionsReportList, Error>,
            > {
                Box::pin(async move {
                    let url_str = &format!(
    ...
    pub mod create {
        ...
        impl Builder {
            pub fn into_future(
                ...
                'static,
                std::result::Result<models::ReferenceLinks, Error>,
            > {
                Box::pin(async move {
                    let url_str = &format!(
                        "{}/{}/_apis/permissionsreport",
    ...
    pub mod get {
        ...
        impl Builder {
            pub fn into_future(
                ...
                'static,
                std::result::Result<models::PermissionsReport, Error>,
            > {
                Box::pin(async move {
                    let url_str = &format!(
                        "{}/{}/_apis/permissionsreport/{}",
