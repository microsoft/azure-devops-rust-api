...
pub mod permissions_report {
    ...
    pub mod list {
        ...
        impl Response {
            pub fn into_body(self) -> azure_core::Result<models::PermissionsReportList> {
                self.0.into_model()
            }
    ...
    pub mod create {
        ...
        impl Response {
            pub fn into_body(self) -> azure_core::Result<models::ReferenceLinks> {
                self.0.into_model()
            }
            pub fn into_raw_response(self) -> azure_core::http::RawResponse {
                self.0.into()
    ...
    pub mod get {
        ...
        impl Response {
            pub fn into_body(self) -> azure_core::Result<models::PermissionsReport> {
                self.0.into_model()
            }
            pub fn into_raw_response(self) -> azure_core::http::RawResponse {
                self.0.into()
