...
pub mod roleassignments {
    ...
    pub mod list {
        ...
        #[derive(Debug)]
        pub struct Response(
            azure_core::http::Response<models::RoleAssignmentList, azure_core::http::JsonFormat>,
        );
        impl Response {
            pub fn into_body(self) -> azure_core::Result<models::RoleAssignmentList> {
                self.0.into_model()
            }
            pub fn into_raw_response(self) -> azure_core::http::RawResponse {
                self.0.into()
    ...
    pub mod set_role_assignment {
        ...
        #[derive(Debug)]
        pub struct Response(
            azure_core::http::Response<models::RoleAssignment, azure_core::http::JsonFormat>,
        );
        impl Response {
            pub fn into_body(self) -> azure_core::Result<models::RoleAssignment> {
                self.0.into_model()
            }
            pub fn into_raw_response(self) -> azure_core::http::RawResponse {
                self.0.into()
...
pub mod roledefinitions {
    ...
    pub mod list {
        ...
        #[derive(Debug)]
        pub struct Response(
            azure_core::http::Response<models::SecurityRoleList, azure_core::http::JsonFormat>,
        );
        impl Response {
            pub fn into_body(self) -> azure_core::Result<models::SecurityRoleList> {
                self.0.into_model()
            }
            pub fn into_raw_response(self) -> azure_core::http::RawResponse {
                self.0.into()
