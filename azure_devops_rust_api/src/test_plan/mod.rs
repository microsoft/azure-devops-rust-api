...
pub mod suite_test_case {
    ...
    impl Client {
        ...
        ) -> remove_test_cases_from_suite::RequestBuilder {
            remove_test_cases_from_suite::RequestBuilder {
                client: self.0.clone(),
        ...
        pub fn get_test_case_list(
            ...
            plan_id: i32,
            suite_id: i32,
        ) -> get_test_case_list::RequestBuilder {
            get_test_case_list::RequestBuilder {
                client: self.0.clone(),
                organization: organization.into(),
                project: project.into(),
        ...
        ) -> remove_test_cases_list_from_suite::RequestBuilder {
            remove_test_cases_list_from_suite::RequestBuilder {
                client: self.0.clone(),
                organization: organization.into(),
                project: project.into(),
    ...
    pub mod get_test_case_list {
        ...
        #[derive(Debug)]
        pub struct Response(
            azure_core::http::Response<models::TestCaseList, azure_core::http::JsonFormat>,
        );
        impl Response {
            pub fn into_body(self) -> azure_core::Result<models::TestCaseList> {
                self.0.into_model()
            }
            pub fn into_raw_response(self) -> azure_core::http::RawResponse {
                self.0.into()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::TestCaseList>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::TestCaseList>>;
...
pub mod test_point {
    ...
    impl Client {
        ...
        pub fn get_points_list(
            ...
            plan_id: i32,
            suite_id: i32,
        ) -> get_points_list::RequestBuilder {
            get_points_list::RequestBuilder {
                client: self.0.clone(),
                organization: organization.into(),
                project: project.into(),
    ...
    pub mod get_points_list {
        ...
        impl Response {
            pub fn into_body(self) -> azure_core::Result<models::TestPointList> {
                self.0.into_model()
            }
            pub fn into_raw_response(self) -> azure_core::http::RawResponse {
                self.0.into()
...
pub mod test_suites {
    ...
    impl Client {
        ...
        pub fn get_suites_by_test_case_id(
            ...
            organization: impl Into<String>,
            test_case_id: i32,
        ) -> get_suites_by_test_case_id::RequestBuilder {
            get_suites_by_test_case_id::RequestBuilder {
                client: self.0.clone(),
                organization: organization.into(),
                test_case_id,
        ...
        pub fn get_test_suites_for_plan(
            ...
            project: impl Into<String>,
            plan_id: i32,
        ) -> get_test_suites_for_plan::RequestBuilder {
            get_test_suites_for_plan::RequestBuilder {
                client: self.0.clone(),
                organization: organization.into(),
                project: project.into(),
    ...
    pub mod get_suites_by_test_case_id {
        ...
        #[derive(Debug)]
        pub struct Response(
            azure_core::http::Response<models::TestSuiteList, azure_core::http::JsonFormat>,
        );
        impl Response {
            pub fn into_body(self) -> azure_core::Result<models::TestSuiteList> {
                self.0.into_model()
            }
            pub fn into_raw_response(self) -> azure_core::http::RawResponse {
                self.0.into()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::TestSuiteList>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::TestSuiteList>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create {
        ...
        #[derive(Debug)]
        pub struct Response(
            azure_core::http::Response<models::TestSuite, azure_core::http::JsonFormat>,
        );
        impl Response {
            pub fn into_body(self) -> azure_core::Result<models::TestSuite> {
                self.0.into_model()
            }
            pub fn into_raw_response(self) -> azure_core::http::RawResponse {
                self.0.into()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::TestSuite>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::TestSuite>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod configurations {
    ...
    pub mod list {
        ...
        #[derive(Debug)]
        pub struct Response(
            azure_core::http::Response<models::TestConfigurationList, azure_core::http::JsonFormat>,
        );
        impl Response {
            pub fn into_body(self) -> azure_core::Result<models::TestConfigurationList> {
                self.0.into_model()
            }
            pub fn into_raw_response(self) -> azure_core::http::RawResponse {
                self.0.into()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::TestConfigurationList>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::TestConfigurationList>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create {
        ...
        #[derive(Debug)]
        pub struct Response(
            azure_core::http::Response<models::TestConfiguration, azure_core::http::JsonFormat>,
        );
        impl Response {
            pub fn into_body(self) -> azure_core::Result<models::TestConfiguration> {
                self.0.into_model()
            }
            pub fn into_raw_response(self) -> azure_core::http::RawResponse {
                self.0.into()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::TestConfiguration>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::TestConfiguration>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod test_plans {
    ...
    pub mod list {
        ...
        #[derive(Debug)]
        pub struct Response(
            azure_core::http::Response<models::TestPlanList, azure_core::http::JsonFormat>,
        );
        impl Response {
            pub fn into_body(self) -> azure_core::Result<models::TestPlanList> {
                self.0.into_model()
            }
            pub fn into_raw_response(self) -> azure_core::http::RawResponse {
                self.0.into()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::TestPlanList>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::TestPlanList>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create {
        ...
        #[derive(Debug)]
        pub struct Response(
            azure_core::http::Response<models::TestPlan, azure_core::http::JsonFormat>,
        );
        impl Response {
            pub fn into_body(self) -> azure_core::Result<models::TestPlan> {
                self.0.into_model()
            }
            pub fn into_raw_response(self) -> azure_core::http::RawResponse {
                self.0.into()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::TestPlan>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::TestPlan>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod test_plan_clone {
    ...
    impl Client {
        ...
        pub fn clone_test_plan(
            ...
            project: impl Into<String>,
        ) -> clone_test_plan::RequestBuilder {
            clone_test_plan::RequestBuilder {
                client: self.0.clone(),
                organization: organization.into(),
                body: body.into(),
    ...
    pub mod clone_test_plan {
        ...
        pub struct Response(
            azure_core::http::Response<
                models::CloneTestPlanOperationInformation,
        ...
        impl Response {
            pub fn into_body(
                self,
            ) -> azure_core::Result<models::CloneTestPlanOperationInformation> {
                self.0.into_model()
            }
            pub fn into_raw_response(self) -> azure_core::http::RawResponse {
                self.0.into()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::CloneTestPlanOperationInformation>;
            type IntoFuture =
                BoxFuture<'static, azure_core::Result<models::CloneTestPlanOperationInformation>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod test_suite_entry {
    ...
    impl Client {
        ...
        pub fn reorder_suite_entries(
            ...
            project: impl Into<String>,
            suite_id: i32,
        ) -> reorder_suite_entries::RequestBuilder {
            reorder_suite_entries::RequestBuilder {
                client: self.0.clone(),
                organization: organization.into(),
                body,
    ...
    pub mod list {
        ...
        #[derive(Debug)]
        pub struct Response(
            azure_core::http::Response<models::SuiteEntryList, azure_core::http::JsonFormat>,
        );
        impl Response {
            pub fn into_body(self) -> azure_core::Result<models::SuiteEntryList> {
                self.0.into_model()
            }
            pub fn into_raw_response(self) -> azure_core::http::RawResponse {
                self.0.into()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::SuiteEntryList>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::SuiteEntryList>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod test_suite_clone {
    ...
    impl Client {
        ...
        pub fn clone_test_suite(
            ...
            project: impl Into<String>,
        ) -> clone_test_suite::RequestBuilder {
            clone_test_suite::RequestBuilder {
                client: self.0.clone(),
                organization: organization.into(),
                body: body.into(),
    ...
    pub mod clone_test_suite {
        ...
        pub struct Response(
            azure_core::http::Response<
                models::CloneTestSuiteOperationInformation,
                azure_core::http::JsonFormat,
            >,
        );
        impl Response {
            pub fn into_body(
                self,
            ) -> azure_core::Result<models::CloneTestSuiteOperationInformation> {
                self.0.into_model()
            }
            pub fn into_raw_response(self) -> azure_core::http::RawResponse {
                self.0.into()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::CloneTestSuiteOperationInformation>;
            type IntoFuture =
                BoxFuture<'static, azure_core::Result<models::CloneTestSuiteOperationInformation>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod test_case_clone {
    ...
    impl Client {
        ...
        pub fn clone_test_case(
            ...
            project: impl Into<String>,
        ) -> clone_test_case::RequestBuilder {
            clone_test_case::RequestBuilder {
                client: self.0.clone(),
                organization: organization.into(),
                body: body.into(),
    ...
    pub mod clone_test_case {
        ...
        pub struct Response(
            azure_core::http::Response<
                models::CloneTestCaseOperationInformation,
                azure_core::http::JsonFormat,
            >,
        );
        impl Response {
            pub fn into_body(
                self,
            ) -> azure_core::Result<models::CloneTestCaseOperationInformation> {
                self.0.into_model()
            }
            pub fn into_raw_response(self) -> azure_core::http::RawResponse {
                self.0.into()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::CloneTestCaseOperationInformation>;
            type IntoFuture =
                BoxFuture<'static, azure_core::Result<models::CloneTestCaseOperationInformation>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
...
pub mod variables {
    ...
    pub mod list {
        ...
        #[derive(Debug)]
        pub struct Response(
            azure_core::http::Response<models::TestVariableList, azure_core::http::JsonFormat>,
        );
        impl Response {
            pub fn into_body(self) -> azure_core::Result<models::TestVariableList> {
                self.0.into_model()
            }
            pub fn into_raw_response(self) -> azure_core::http::RawResponse {
                self.0.into()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::TestVariableList>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::TestVariableList>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
    ...
    pub mod create {
        ...
        #[derive(Debug)]
        pub struct Response(
            azure_core::http::Response<models::TestVariable, azure_core::http::JsonFormat>,
        );
        impl Response {
            pub fn into_body(self) -> azure_core::Result<models::TestVariable> {
                self.0.into_model()
            }
            pub fn into_raw_response(self) -> azure_core::http::RawResponse {
                self.0.into()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::TestVariable>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::TestVariable>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
