...
pub enum Error {
    ...
    #[error(transparent)]
    Avatar_SetProjectAvatar(#[from] avatar::set_project_avatar::Error),
    #[error(transparent)]
    Avatar_RemoveProjectAvatar(#[from] avatar::remove_project_avatar::Error),
    #[error(transparent)]
    Projects_GetProjectProperties(#[from] projects::get_project_properties::Error),
    #[error(transparent)]
    Projects_SetProjectProperties(#[from] projects::set_project_properties::Error),
    #[error(transparent)]
    Teams_GetTeams(#[from] teams::get_teams::Error),
    #[error(transparent)]
    Teams_Create(#[from] teams::create::Error),
    #[error(transparent)]
    Teams_Get(#[from] teams::get::Error),
    #[error(transparent)]
    Teams_Update(#[from] teams::update::Error),
    #[error(transparent)]
    Teams_Delete(#[from] teams::delete::Error),
    #[error(transparent)]
    Teams_GetTeamMembersWithExtendedProperties(
        #[from] teams::get_team_members_with_extended_properties::Error,
    ),
    #[error(transparent)]
    Teams_GetAllTeams(#[from] teams::get_all_teams::Error),
}
pub mod processes {
    use super::{models, API_VERSION};
    ...
    pub mod list {
        ...
        impl Builder {
            pub fn into_future(
                self,
            ) -> futures::future::BoxFuture<'static, std::result::Result<models::ProcessList, Error>>
            {
                Box::pin(async move {
                    let url_str = &format!(
                    ...
                    match rsp_status {
                        http::StatusCode::OK => {
                            ...
                            let rsp_value: models::ProcessList = serde_json::from_slice(&rsp_body)
    ...
    pub mod get {
        ...
        impl Builder {
            pub fn into_future(
                self,
            ) -> futures::future::BoxFuture<'static, std::result::Result<models::Process, Error>>
            {
                Box::pin(async move {
                    let url_str = &format!(
                        "{}/{}/_apis/process/processes/{}",
...
pub mod projects {
    ...
    pub mod list {
        ...
        impl Builder {
            ...
            pub fn into_future(
                ...
                'static,
                std::result::Result<models::TeamProjectReferenceList, Error>,
            > {
                Box::pin(async move {
                    let url_str = &format!(
                        "{}/{}/_apis/projects",
                    ...
                    if let Some(get_default_team_image_url) = &self.get_default_team_image_url {
    ...
    pub mod get {
        ...
        impl Builder {
            ...
            pub fn into_future(
                self,
            ) -> futures::future::BoxFuture<'static, std::result::Result<models::TeamProject, Error>>
            {
                Box::pin(async move {
                    let url_str = &format!(
                        "{}/{}/_apis/projects/{}",
                    ...
                    match rsp_status {
                        http::StatusCode::OK => {
                            let rsp_body = azure_core::collect_pinned_stream(rsp_stream)
                                .await
                                .map_err(Error::ResponseBytes)?;
                            let rsp_value: models::TeamProject = serde_json::from_slice(&rsp_body)
                                .map_err(|source| Error::Deserialize(source, rsp_body.clone()))?;
                            Ok(rsp_value)
                        }
                        status_code => {
    ...
    pub mod get_project_properties {
        ...
        impl Builder {
            ...
            pub fn into_future(
                ...
                'static,
                std::result::Result<models::ProjectPropertyList, Error>,
            > {
                Box::pin(async move {
                    let url_str = &format!(
...
pub mod teams {
    ...
    pub mod get_teams {
        ...
        impl Builder {
            ...
            pub fn into_future(
                ...
                'static,
                std::result::Result<models::WebApiTeamList, Error>,
            > {
                Box::pin(async move {
                    let url_str = &format!(
                    ...
                    if let Some(expand_identity) = &self.expand_identity {
                        url.query_pairs_mut()
    ...
    pub mod create {
        ...
        impl Builder {
            pub fn into_future(
                self,
            ) -> futures::future::BoxFuture<'static, std::result::Result<models::WebApiTeam, Error>>
            {
                Box::pin(async move {
                    let url_str = &format!(
                        "{}/{}/_apis/projects/{}/teams",
                    ...
                    match rsp_status {
                        http::StatusCode::OK => {
                            let rsp_body = azure_core::collect_pinned_stream(rsp_stream)
                                .await
                                .map_err(Error::ResponseBytes)?;
                            let rsp_value: models::WebApiTeam = serde_json::from_slice(&rsp_body)
                                .map_err(|source| {
                                Error::Deserialize(source, rsp_body.clone())
                            })?;
                            Ok(rsp_value)
    ...
    pub mod get_team_members_with_extended_properties {
        ...
        impl Builder {
            ...
            pub fn into_future(
                ...
                'static,
                std::result::Result<models::TeamMemberList, Error>,
            > {
                Box::pin(async move {
                    let url_str = &format!(
