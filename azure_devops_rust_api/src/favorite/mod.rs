...
pub mod favorites {
    ...
    pub mod get_favorites_of_owner {
        ...
        impl Response {
            pub async fn into_raw_body(self) -> azure_core::Result<models::FavoriteList> {
    ...
    pub mod create_favorite_of_owner {
        ...
        pub struct Response(azure_core::Response);
        impl Response {
            pub async fn into_raw_body(self) -> azure_core::Result<models::Favorite> {
                let bytes = self.0.into_raw_body().collect().await?;
    ...
    pub mod get_favorite_by_artifact {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/{}/_apis/favorite/favorites?artifactType={}&artifactId={}&artifactScopeType={}" , self . client . endpoint () , & self . organization , & self . artifact_type , & self . artifact_id , & self . artifact_scope_type)) ? ;
                let has_api_version_already = url
                    .query_pairs()
                    .any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
    ...
    pub mod delete_favorite_of_owner_by_id {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/{}/_apis/favorite/favorites/{}?ownerScopeType={}&ownerScopeId={}&artifactType={}&artifactScopeType={}" , self . client . endpoint () , & self . organization , & self . favorite_id , & self . owner_scope_type , & self . owner_scope_id , & self . artifact_type , & self . artifact_scope_type)) ? ;
                let has_api_version_already = url
                    .query_pairs()
                    .any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
    ...
    pub mod get_favorite_of_owner_by_id {
        ...
        impl RequestBuilder {
            ...
            fn url(&self) -> azure_core::Result<azure_core::Url> {
                let mut url = azure_core :: Url :: parse (& format ! ("{}/{}/_apis/favorite/favorites/{}?ownerScopeType={}&ownerScopeId={}&artifactScopeType={}&artifactType={}" , self . client . endpoint () , & self . organization , & self . favorite_id , & self . owner_scope_type , & self . owner_scope_id , & self . artifact_scope_type , & self . artifact_type)) ? ;
                let has_api_version_already = url
                    .query_pairs()
                    .any(|(k, _)| k == azure_core::query_param::API_VERSION);
                if !has_api_version_already {
