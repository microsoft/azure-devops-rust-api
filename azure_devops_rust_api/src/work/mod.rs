...
pub mod plans {
    ...
    pub mod create {
        ...
        impl RequestBuilder {
            ...
            pub fn into_future(
                self,
            ) -> futures::future::BoxFuture<'static, azure_core::Result<models::Plan>> {
                Box::pin(async move { self.send().await?.into_body().await })
            }
        }
    }
...
pub mod processconfiguration {
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            pub fn into_future(
                self,
            ) -> futures::future::BoxFuture<'static, azure_core::Result<models::ProcessConfiguration>>
            {
                Box::pin(async move { self.send().await?.into_body().await })
            }
        }
...
pub mod backlogconfiguration {
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            pub fn into_future(
                self,
            ) -> futures::future::BoxFuture<'static, azure_core::Result<models::BacklogConfiguration>>
            {
                Box::pin(async move { self.send().await?.into_body().await })
            }
        }
...
pub mod boardparents {
    ...
    pub mod list {
        ...
        impl RequestBuilder {
            ...
            pub fn into_future(
                self,
            ) -> futures::future::BoxFuture<'static, azure_core::Result<models::ParentChildWiMapList>>
            {
                Box::pin(async move { self.send().await?.into_body().await })
            }
        }
...
pub mod teamdaysoff {
    ...
    pub mod get {
        ...
        impl RequestBuilder {
            ...
            pub fn into_future(
                self,
            ) -> futures::future::BoxFuture<'static, azure_core::Result<models::TeamSettingsDaysOff>>
            {
                Box::pin(async move { self.send().await?.into_body().await })
            }
        }
