...
pub enum Error {
    #[error(transparent)]
    Health_Get(#[from] health::get::Error),
}
pub mod health {
    use super::{models, API_VERSION};
    ...
    pub mod get {
        ...
        impl Builder {
            ...
            pub fn into_future(
                ...
                'static,
                std::result::Result<models::ServiceStatus, Error>,
            > {
                Box::pin(async move {
                    let url_str = &format!("{}/_apis/status/health", self.client.endpoint(),);
                    ...
                    if let Some(geographies) = &self.geographies {
                        url.query_pairs_mut()
