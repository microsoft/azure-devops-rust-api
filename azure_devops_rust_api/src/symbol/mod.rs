...
azure_core::static_url!(DEFAULT_ENDPOINT, "https://artifacts.dev.azure.com");
impl ClientBuilder {
...
pub mod requests {
    ...
    pub mod create_requests_request_name_debug_entries {
        ...
        #[derive(Debug)]
        pub struct Response(
            azure_core::http::Response<models::DebugEntryList, azure_core::http::JsonFormat>,
        );
        impl Response {
            pub fn into_body(self) -> azure_core::Result<models::DebugEntryList> {
                self.0.into_model()
            }
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::DebugEntryList>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::DebugEntryList>>;
    ...
    pub mod get_requests_request_name {
        ...
        #[derive(Debug)]
        pub struct Response(
            azure_core::http::Response<models::Request, azure_core::http::JsonFormat>,
        );
        impl Response {
            pub fn into_body(self) -> azure_core::Result<models::Request> {
                self.0.into_model()
            }
            pub fn into_raw_response(self) -> azure_core::http::RawResponse {
                self.0.into()
        ...
        impl std::future::IntoFuture for RequestBuilder {
            type Output = azure_core::Result<models::Request>;
            type IntoFuture = BoxFuture<'static, azure_core::Result<models::Request>>;
            #[doc = "Returns a future that sends the request and returns the parsed response body."]
            #[doc = ""]
            #[doc = "You should not normally call this method directly, simply invoke `.await` which implicitly calls `IntoFuture::into_future`."]
            #[doc = ""]
