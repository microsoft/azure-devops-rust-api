...
pub mod wikis {
    ...
    pub mod list {
        ...
        impl Response {
            pub fn into_body(self) -> azure_core::Result<models::WikiV2List> {
                self.0.into_model()
            }
    ...
    pub mod create {
        ...
        impl Response {
            pub fn into_body(self) -> azure_core::Result<models::WikiV2> {
                self.0.into_model()
            }
            pub fn into_raw_response(self) -> azure_core::http::RawResponse {
                self.0.into()
...
pub mod attachments {
    ...
    pub mod create {
        ...
        impl Response {
            pub fn into_body(self) -> azure_core::Result<models::WikiAttachment> {
                self.0.into_model()
            }
            pub fn into_raw_response(self) -> azure_core::http::RawResponse {
                self.0.into()
...
pub mod page_moves {
    ...
    pub mod create {
        ...
        impl Response {
            pub fn into_body(self) -> azure_core::Result<models::WikiPageMove> {
                self.0.into_model()
            }
            pub fn into_raw_response(self) -> azure_core::http::RawResponse {
                self.0.into()
...
pub mod pages {
    ...
    pub mod get_page {
        ...
        impl Response {
            pub fn into_body(self) -> azure_core::Result<models::WikiPage> {
                self.0.into_model()
            }
            pub fn into_raw_response(self) -> azure_core::http::RawResponse {
                self.0.into()
...
pub mod page_stats {
    ...
    pub mod get {
        ...
        impl Response {
            pub fn into_body(self) -> azure_core::Result<models::WikiPageDetail> {
                self.0.into_model()
            }
            pub fn into_raw_response(self) -> azure_core::http::RawResponse {
                self.0.into()
...
pub mod pages_batch {
    ...
    pub mod get {
        ...
        impl Response {
            pub fn into_body(self) -> azure_core::Result<models::WikiPageDetailList> {
                self.0.into_model()
            }
            pub fn into_raw_response(self) -> azure_core::http::RawResponse {
                self.0.into()
