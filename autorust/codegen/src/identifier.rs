...
mod tests {
    ...
    fn test_gcm_aes_128() -> Result<(), Error> {
        assert_eq!(
            "gcm-aes-128".to_camel_case_ident()?.to_string(),
            "GcmAes128"
        );
        Ok(())
    }
    ...
    fn test_attr_qualified_name() -> Result<(), Error> {
        assert_eq!(
            "attr:qualifiedName".to_snake_case_ident()?.to_string(),
            "attr_qualified_name"
        );
        Ok(())
    }
    ...
    fn test_odata_type() -> Result<(), Error> {
        assert_eq!(
            "@odata.type".to_camel_case_ident()?.to_string(),
            "OdataType"
        );
        Ok(())
    }
    ...
    fn test_10minutely() -> Result<(), Error> {
        assert_eq!(
            "_10minutely".to_camel_case_ident()?.to_string(),
            "N10minutely"
        );
        Ok(())
    }
