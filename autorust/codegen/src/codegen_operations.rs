use crate::{
    ...
    status_codes::{
        get_error_responses, get_response_type_name, get_success_responses, has_default_response,
    },
...
fn create_operation_code(
    cg: &CodeGen,
    operation: &WebOperationGen,
) -> Result<OperationCode, Error> {
