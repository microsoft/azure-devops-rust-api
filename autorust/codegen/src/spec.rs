...
use autorust_openapi::{
    AdditionalProperties, CollectionFormat, DataType, MsExamples, MsLongRunningOperationOptions,
    MsPageable, OpenAPI, Operation, Parameter, ParameterIn, PathItem, Reference, ReferenceOr,
    Response, Schema, SchemaCommon, StatusCode,
};
